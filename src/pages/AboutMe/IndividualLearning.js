    ...
    return (
        <>
            ...
            <Container>
                ...
                <ParagraphContainer>
                    <ParagraphTitle>1<strong>Персональная адаптация программы:</strong></ParagraphTitle>
                    <Paragraph>
                    ...
                    <Paragraph>
                        Первым шагом в индивидуальном обучении является изучение ваших потребностей и целей. На основе этой информации я разрабатываю уникальную программу, которая наилучшим образом соответствует вашим запросам.
                    </Paragraph> <ParagraphTitle>1<strong>Персональная адаптация программы:</strong></ParagraphTitle>
                    <Paragraph>
                        Первым шагом в индивидуальном обучении является изучение ваших потребностей и целей. На основе этой информации я разрабатываю уникальную программу, которая наилучшим образом соответствует вашим запросам.
                    </Paragraph> <ParagraphTitle>1<strong>Персональная адаптация программы:</strong></ParagraphTitle>
                    <Paragraph>
